...
def CreateOverlay():
    ...
    # Read the images
    image_original = cv2.imread('Frame.jpg')
    ...
    for index, element in enumerate(image_masks):
        ...
        #cv2.putText(image_overlay_result, "Confidence: " + str(result_score*100)[:4 + (1-1)] + '%', (centerX - 350, centerY + textThickness * 20), font, fontSize, (0, 0, 0), textThickness, cv2.LINE_AA)          
...
f = tf.gfile.FastGFile("ParkingLotOccupancyDetection/retrained_graph.pb", 'rb')
